  ...
  const messages = promptArray
    ...
    .reduce((acc, prompt) => {
      ...
      const patterns = [
        ...
        {
          key: 'muscleGroup',
          regex: /(back and bicep|chest and tricep|legs|shoulders|full body)/i,
        ...
        },
        {
          ...
          format: (value: string, unit?: string) => `Duration: ${value} ${unit}`,
        },
      ];
...
export const getResponse = async (
  ...
  const openAIMessages = [
    ...
    {
      role: "user",
      content: "Please prioritize the following updates and adjust previous information accordingly. In the case of contradicting requests, prioritize the latest ones and strictly adhere to any numbers.",
    },
