export const SYSTEM_PROMPT =
  ...
  "Always include at least 8 exercises, and take any timing queries into account." +
  "Your next top priority is that in your response, please have no preamble, no numbering for each workout, and your main priority in responding is " +
